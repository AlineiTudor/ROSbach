...
publisher_name='internal_diff_press'
publisher_topic='/internal/pressure'
...
def decode_info(data):
    global seq,odom_msg
    #id 29 for scaled_pressure which is internal barometer sensor
    if data.msgid==29:
        ...
        odom_msg.data=press_diff*100#convert from hPa to Pa
