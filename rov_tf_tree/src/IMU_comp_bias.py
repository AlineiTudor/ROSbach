...
def remove_gravit_acc2(data):
    ...
    f = open("/home/alineitudor/Licenta/BagFiles/IMU_and_depth/acc_proj.txt", "w")
    ...
    return [imu_acc_quat[0]-acc_proj[0],imu_acc_quat[1]-acc_proj[1],imu_acc_quat[2]-acc_proj[2]]
