...
def decode_info(data):
    ...
    if data.msgid==137:
        ...
        odom_msg.header.frame_id="Rov_frame"
        odom_msg.header.stamp=data.header.stamp
        odom_msg.header.seq=seq
        seq+=1
        odom_msg.child_frame_id="Bar30_frame"

        #press_diff is in mbar and we need to convert to Pa=>(0.001[bar]*10^5)Pa=>100 Pa
        odom_msg.pose.pose.position.z=-press_diff*100/water_density/g
        ...
        pub.publish('/odometry/Bar30',odom_msg)
